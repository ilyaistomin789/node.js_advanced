...
--  SQLINES DEMO *** ----------------------------------------------------------------------------------------------------        - DROP  TABLE TEACHER
...
--  SQLINES DEMO *** -------------------------------------------------------------------------------------------------
-- SQLINES DEMO *** RIUM_TYPE
create table AUDITORIUM_TYPE
(
  AUDITORIUM_TYPE   VARCHAR(10) ,
...
(
 AUDITORIUM           VARCHAR(10) primary key,  -- SQLINES DEMO *** ории
 AUDITORIUM_NAME      varchar(200),          -- аудитория
 AUDITORIUM_CAPACITY  smallint,              -- SQLINES DEMO *** ?ть
 AUDITORIUM_TYPE      VARCHAR(10) not null      -- SQLINES DEMO *** ории
